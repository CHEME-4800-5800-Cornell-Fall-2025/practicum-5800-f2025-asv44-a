...
# Notes to self: need a Decode Method, build Method(pass in linear image collection stored in memories), field called energy set as well, MyClassicalHopfieldNetworkModel(field: memories),recover method
